...
void *game(void *arg)
{
    ...
    server->server_timer_count = get_current_timer_units(server, &server->server_timer);
    server->density_timer_count = get_current_timer_units(server, &server->density_timer);
